<x-admin::layouts>
    ...
    <form method="POST" action="{{ route('admin.amazon-products.update', $product->id) }}" class="mt-5 box-shadow rounded bg-white p-6 dark:bg-gray-900">
        @csrf
        @method('PUT')
